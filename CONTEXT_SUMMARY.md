...
- Deploiement : Vercel CLI direct (pas de repo Git), compte `hachemimowgli-2820`, team `hachemimowgli-2820s-projects`
...
- **v1 `elecarm-crisis`** (`elecarm-crisis.vercel.app`, local `~/projects/elecarm-crisis/src/`) : gelee, ne jamais toucher, sert juste de reference historique
...
## Principes de design etablis (a respecter dans toute future modification)
